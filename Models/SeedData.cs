           ...
           context.Database.EnsureCreated();
                ...
                var book = new Book[] {
                    new Book { 
                        ...
                        Authorid=author.Single(d=>d.FirstName=="Донато" && d.LastName=="Каризи").AuthorID,
                        Title="Шепнувачот",
                     ...
                     new Book { 
                        ...
                        Authorid=author.Single(d=>d.FirstName=="Труман" && d.LastName=="Капоти").AuthorID,
                     ...
                     new Book { 
                        ...
                        Authorid=author.Single(d=>d.FirstName=="Агата" && d.LastName=="Кристи").AuthorID,
                       ...
                       new Book { 
                        ...
                        Authorid=author.Single(d=>d.FirstName=="Џејн" && d.LastName=="Остин").AuthorID,
                    ...
                    new Book { 
                        ...
                        Authorid=author.Single(d=>d.FirstName=="Петре" && d.LastName=="М. Андреевски").AuthorID,
                        Title="Дениција",
                    ...
                    new Book { 
                        ...
                        Authorid=author.Single(d=>d.FirstName=="Антоан Де" && d.LastName=="Сент-Егзипери").AuthorID,
                        Title="Малиот принц",
                ...
                var movie=new Movie[]{
                    new Movie { 
                        ...
                        BookId = book.Single(d=>d.Title=="Појадок кај Тифани").BooksID,
                    ...
                    new Movie { 
                        ...
                        BookId = book.Single(d=>d.Title=="Убиство во Ориент-Експрес").BooksID,
                    ...
                    new Movie { 
                        ...
                        BookId = book.Single(d=>d.Title=="Гордост и предрасуда").BooksID,
                    ...
                    new Movie { 
                        ...
                        BookId = book.Single(d=>d.Title=="Малиот принц").BooksID,
